...
Helm Chart for Geonode. Supported versions: Geonode: 4.4.3, Geoserver: 2.24.3-v2, pyCSW: 2.6.1
...
| geoserver.image.tag | string | `"2.24.3-v2"` | geoserver docker image tag |
...
| geoserver_data.image.tag | string | `"2.24.4-v3"` | geoserver docker image tag |
